...
var UtilService = /** @class */ (function () {
    ...
    UtilService.requestImagePermission = function () {
    ...
    UtilService.pickImage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UtilService.alterColor = function (color, step) {
        var intColor = parseInt(color.substr(1), 16);
        var hexColor = (intColor + step).toString(16);
