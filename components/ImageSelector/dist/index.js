...
var ImageSelector = function (_a) {
  ...
  var _b = react_1.useState(imageUri),
    uri = _b[0],
    setUri = _b[1];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              UtilService_1["default"].pickImage(),
            ];
          case 1:
            uri = _a.sent();
            if (uri) {
  ...
  return react_1["default"].createElement(
    ...
    react_1["default"].createElement(
      react_native_1.View,
      {
        style: [ImageSelectorStyle_1["default"].container],
      },
      react_1["default"].createElement(
        react_native_1.Text,
        null,
      ...
      uri
        ? react_1["default"].createElement(
            react_native_1.Image,
            {
              ...
              source: { uri: uri },
              style: [
                ImageSelectorStyle_1["default"].selected,
              ],
            }
          )
        : react_1["default"].createElement(
