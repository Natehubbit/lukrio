...
var SlidePagination = function (_a) {
    var pages = _a.pages, page = _a.page;
    var dots = new Array(pages).fill(0);
    return (react_1["default"].createElement(react_native_1.View, { style: [SlidePaginationStyle_1["default"].container] }, dots.map(function (_, i) {
        var isActive = i === page;
