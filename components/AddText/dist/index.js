...
var AddText = function (_a) {
    ...
    var onBlur = function (val) {
        ...
        setText(val);
        if (isHeader) {
            dispatch(slideSlice_1.slideActions.setHeader({ id: slideId, text: val }));
        }
        if (isAdder) {
            setText("");
        }
    ...
    var style = isHeader
        ? AddTextStyle_1["default"].title
        : AddTextStyle_1["default"].subText;
    var spacing = !isHeader
        ? AddTextStyle_1["default"].subSpace
        : AddTextStyle_1["default"].titleSpace;
    ...
    return (react_1["default"].createElement(react_native_1.View, { style: [AddTextStyle_1["default"].root, spacing] },
        ...
        react_1["default"].createElement(react_native_1.TouchableOpacity, { onPress: onEdit, style: [AddTextStyle_1["default"].container, subTextRootStyle] }, !editing ? (react_1["default"].createElement(react_native_1.Text, { numberOfLines: 10, style: [style, textStyle, subStyle] }, !!val
            ? val
            : isHeader
                ? "Tap to add title"
                : "Tap to add subtext")) : (react_1["default"].createElement(react_native_1.TextInput, { ref: ref, style: [style], multiline: !isHeader, defaultValue: val, onEndEditing: function (e) { return onBlur(e.nativeEvent.text); } }))),
        hasSubText && (react_1["default"].createElement(react_native_1.View, { style: [AddTextStyle_1["default"].btns] },
            react_1["default"].createElement(react_native_1.TouchableOpacity, { onPress: function () { return setTextId(id); }, style: [AddTextStyle_1["default"].actionBtn] },
                react_1["default"].createElement(Icon_1["default"], { name: "pencil-circle", color: theme_1.COLORS.white.val, size: react_native_responsive_screen_1.heightPercentageToDP("3%") })),
