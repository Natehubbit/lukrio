...
var AddText = function AddText(_a) {
  ...
  var onBlur = function onBlur(val) {
    ...
    if (isHeader) {
      dispatch(
        slideSlice_1.slideActions.setHeader({
          id: slideId,
          text: val,
        })
      );
    ...
    if (val && !text && !isHeader) {
      dispatch(
        slideSlice_1.slideActions.addSubText({
          id: slideId,
          text: val,
        })
      );
    ...
    if (val && text && !isHeader) {
      dispatch(
        slideSlice_1.slideActions.updateSubtext({
          slideId: slideId,
          text: val,
          textId: id,
        })
  ...
  var onDelete = function onDelete() {
    dispatch(
      slideSlice_1.slideActions.removeSubtext({
        idx: id,
        slideId: slideId,
      })
    );
  ...
  var textStyle =
    hasSubText && AddTextStyle_1["default"].editedSubText;
  var subTextRootStyle =
    hasSubText &&
    AddTextStyle_1["default"].editedSubContainer;
  return react_1["default"].createElement(
    ...
    react_1["default"].createElement(
      react_native_1.TouchableOpacity,
      {
        onPress: onEdit,
        style: [
          AddTextStyle_1["default"].container,
          subTextRootStyle,
        ],
      },
      !editing
