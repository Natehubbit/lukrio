...
var EditorStyle = react_native_1.StyleSheet.create({
    ...
    header: {
        paddingHorizontal: react_native_responsive_screen_1.widthPercentageToDP("3%"),
        justifyContent: "space-between",
        alignItems: "center",
        flexDirection: "row"
    },
    heading: {
        fontSize: react_native_responsive_screen_1.heightPercentageToDP("3%"),
    ...
    noTextSelected: {
        padding: react_native_responsive_screen_1.heightPercentageToDP("2%"),
        opacity: 0.5
    }
});
