...
var EditorStyle_1 = require("./EditorStyle");
...
var Editor = function () {
    ...
    var onAddImage = function (uri) {
        dispatch(slideSlice_1.slideActions.addSubImage({
            id: slideId,
            text: uri
        }));
    };
    return (react_1["default"].createElement(moti_1.View, { style: [EditorStyle_1["default"].container], from: { translateY: height }, animate: { translateY: 0 }, transition: { type: "spring", damping: 50 } },
        react_1["default"].createElement(moti_1.View, { style: [EditorStyle_1["default"].header] },
            react_1["default"].createElement(react_native_1.Text, { style: [EditorStyle_1["default"].heading] }, "Tools"),
            react_1["default"].createElement(moti_1.View, { style: [EditorStyle_1["default"].actions] },
        ...
        react_1["default"].createElement(moti_1.View, null, Object.keys(constants_1.EDIT_TOOLS).map(function (k, i) {
            ...
            return (react_1["default"].createElement(EditorItem_1["default"], { expanded: isText ? textExpanded : imageExpanded, key: key, label: key }, hasText && isText ? (react_1["default"].createElement(react_1["default"].Fragment, null,
                ...
                isText && (react_1["default"].createElement(ColorSelector_1["default"], { type: "text" })))) : isBack ? (react_1["default"].createElement(ColorSelector_1["default"], { isGradient: true, type: "background" })) : isAddImg ? (react_1["default"].createElement(ImageSelector_1["default"], { onSelect: onAddImage })) : (!isIcon && (react_1["default"].createElement(moti_1.View, { style: [EditorStyle_1["default"].noTextSelected] },
