...
var BulletSelector = function (_a) {
  ...
  var _b = useEditor_1["default"](),
    textId = _b.textId,
    slideId = _b.slideId,
    bullet = _b.bullet;
  var _c = react_1.useState(bullet),
    value = _c[0],
    setValue = _c[1];
  var onPress = function (v) {
    setValue(v);
    dispatch(
      slideSlice_1.slideActions.setSubTextBullet({
        slideId: slideId,
        bullet: v,
        idx: textId,
      })
  ...
  return react_1["default"].createElement(
    react_native_1.View,
    { style: [BulletSelectorStyle_1["default"].container] },
    react_1["default"].createElement(
      react_native_1.Text,
      { style: [BulletSelectorStyle_1["default"].label] },
      "Bullet"
    ),
    react_1["default"].createElement(
