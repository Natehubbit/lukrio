...
exports.Color = function (_a) {
    var color = _a.color, type = _a.type, active = _a.active, onPress = _a.onPress;
    ...
    return react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(react_native_1.TouchableOpacity, { onPress: onPress, style: [
            ...
            ] }, active && react_1["default"].createElement(Icon_1["default"], { size: react_native_responsive_screen_1.heightPercentageToDP('2%'), name: 'check-circle', style: ColorStyle_1["default"].activeIcon })));
};
