...
var ColorSelector = function (_a) {
  ...
  var _e = react_1.useState(
      (_b =
        background === null || background === void 0
          ? void 0
          : background.colors) === null || _b === void 0
        ? void 0
        : _b.gradient
    ),
    colors = _e[0],
    setColors = _e[1];
  var _f = react_1.useState("gradient"),
    mode = _f[0],
    setMode = _f[1];
      ...
      if (!isBackground) {
        ...
        setColors(
          (_a =
            background === null || background === void 0
              ? void 0
              : background.colors) === null || _a === void 0
            ? void 0
            : _a.gradient
        );
      }
  ...
  var setMonoBackground = function (color) {
    isBackground &&
      dispatch(
        slideSlice_1.slideActions.setBackground({
          slideId: slideId,
          background: {
            mono: color,
            colors: {
  ...
  return react_1["default"].createElement(
    ...
    isBackground &&
      react_1["default"].createElement(
        ...
        {
          style: [
            ColorSelectorStyle_1["default"].modeContainer,
          ],
        },
        constants_1.BACKGROUND_TYPE.map(function (t) {
          var backType = t.toLowerCase();
          return react_1["default"].createElement(
            react_native_1.View,
            {
              key: t,
              style: ColorSelectorStyle_1["default"].mode,
            },
            react_1["default"].createElement(
              react_native_1.Text,
              null,
            ...
            react_1["default"].createElement(
              react_native_1.Switch,
              {
                value: mode === backType,
                onValueChange: function (v) {
                  return onChangeMode(v, backType);
                },
              }
            )
          );
    ...
    react_1["default"].createElement(
      react_native_1.View,
      { style: ColorSelectorStyle_1["default"].container },
      isGradient &&
        isBackground &&
        react_1["default"].createElement(
          react_native_1.View,
          {
            style:
              ColorSelectorStyle_1["default"].typeContainer,
          },
          react_1["default"].createElement(
            GradientSelector_1["default"],
            null
          )
        ),
      (!isImage && !isGradient) ||
        (isText &&
          react_1["default"].createElement(
            ...
            {
              style:
                ColorSelectorStyle_1["default"]
                  .colorContainer,
            },
            constants_1.COLORS.map(function (c) {
              return react_1["default"].createElement(
                Color_1["default"],
                {
                  key: c,
